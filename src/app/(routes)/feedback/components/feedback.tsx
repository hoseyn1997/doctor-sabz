        ...
        <div className="flex flex-wrap gap-1 items-center">
          <div className="block">
            ...
            <input
              ...
              className="focus-visible:outline-none focus-visible:shadow-[0px_0px_2px_gray] py-2 px-0.5 dark:bg-black ring-[0.5px] dark:ring-gray-100/80 ring-gray-400 rounded-md placeholder:text-gray-300/60 placeholder:text-xs"
            />
          </div>
          <div className="block">
            <p className="px-1 text-gray-400/80 dark:text-gray-400 text-xs">
            ...
            <div className="flex items-center ring-[0.5px] ring-gray-400 p-2 py-2.5 rounded-md">
              <Icons.star className="w-4 cursor-pointer stroke-[1px] stroke-gray-200" />
              <Icons.star className="w-4 cursor-pointer fill-yellow-500 stroke-[1px] stroke-gray-200" />
              <Icons.star className="w-4 cursor-pointer fill-yellow-500 stroke-[1px] stroke-gray-200" />
              <Icons.star className="w-4 cursor-pointer fill-yellow-500 stroke-[1px] stroke-gray-200" />
              <Icons.star className="w-4 cursor-pointer fill-yellow-500 stroke-[1px] stroke-gray-200" />
            </div>
